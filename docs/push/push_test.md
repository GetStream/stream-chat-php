...
- Your app has push notifications configured for at least one provider [in your app settings](/chat/docs/php/app_setting_overview/)

- You have a user that has at least one [device](/chat/docs/php/#push_devices/) associated
...
```php
$client->checkPush(["message_id" => $message["id"], "skip_devices" => true, "user_id" => $user["id"]]);
```
