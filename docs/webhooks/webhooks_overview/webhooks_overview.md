...
> [!NOTE]
> For reliable event delivery, you can also configure [SQS](/chat/docs/php/sqs/) or [SNS](/chat/docs/php/sns/) instead of webhooks.
...
| [Before Message Send](/chat/docs/php/before_message_send_webhook/) | Allows you to modify or moderate message content before sending it to the chat for everyone to see |
| [Custom Commands](/chat/docs/php/custom_commands_webhook/)         | Reacts to custom /slash commands                                                                   |
...
For more information on configuring pending messages, please refer to the [Pending Messages](/chat/docs/php/pending_messages/) documentation.
