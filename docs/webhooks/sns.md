...
The complete list of supported events is identical to those sent through webhooks and can be found on the [Events](/chat/docs/php/webhook_events/) page.
...
$client->updateAppSettings([
    'event_hooks' => array_merge($existingHooks, [$newSNSHook])
]);
