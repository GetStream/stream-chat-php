...
- **Application Permissions** : You can grant these using the .app scope. These permissions apply to operations that occur outside of channel-types including accessing and [modifying other users](/chat/docs/php/update_users/), or [using moderation features](/chat/docs/php/moderation/).
...
> [!NOTE]
> You can also find all available permissions on [Permissions Reference](/chat/docs/php/permissions_reference/) page
...
For grouping users into teams (or tenants) to keep their data strictly segregated, see [Multi-Tenancy](/chat/docs/php/multi_tenant_chat/).
