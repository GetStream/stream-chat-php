...
```php
$filter = ['members' => ['$in' => ['thierry']], 'type' => 'messaging'];
```
...
> [!NOTE]
> For supported query operators, see [Query Syntax Operators](/chat/docs/php/query_syntax_operators/).
...
For the full list of supported query operators, see [Query Syntax Operators](/chat/docs/php/query_syntax_operators/).
