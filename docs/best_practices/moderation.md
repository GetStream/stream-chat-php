...
For more details on permissions, see [User Permissions](/chat/docs/php/chat_permission_policies/).
...
For more details, see [App Settings](/chat/docs/php/app_setting_overview/).
...
For more details, see [Slow Mode & Throttling](/chat/docs/php/slow_mode/).
