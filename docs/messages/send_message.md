...
> [!WARNING]
> Deleting a message does not delete its file attachments. See [deleting attachments](/chat/docs/php/file_uploads/#deleting-files-and-images/) for more information.
...
```php
$client->undeleteMessage("message-id", "user-id");
```
